...
def preprocess_ms2(peaks, prec_mz,
    ...
    remove_electronic_noise : bool, optional
        Whether to remove electronic noise peaks. Defaults to False, which does not remove electronic noise peaks.
    ...
    # Step 8. Power the intensity.
    peaks[:, 1] = np.power(peaks[:, 1], peak_intensity_power)

    # Step 9. Normalize the intensity.
