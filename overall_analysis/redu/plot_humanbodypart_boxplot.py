...
def create_human_body_part_boxplot():
    ...
    ax.tick_params(axis='x', which='major', labelsize=4.5, colors='0.2',
                   length=1, rotation=20, pad=0.5, width=0.5)
    ...
    # Save the plot
    plt.tight_layout()
    # plt.savefig('data/human_body_part_annotation_boxplot.png', format='png', dpi=600,
    #             bbox_inches='tight')
    plt.savefig('data/human_body_part_annotation_boxplot.svg', format='svg',
